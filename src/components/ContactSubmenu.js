...
export default function ContactSubmenu({ selected }) {
  ...
  return (
    <div className="contact-submenu">
      <SubmenuLink href="/kontakt" active={selected === "kontakt"}>
        {content[lang].buttons[0]}
      </SubmenuLink>
      <SubmenuLink href="/gruppen" active={selected === "gruppen"}>
        {content[lang].buttons[1]}
      </SubmenuLink>
      <SubmenuLink
        href="/press-och-media"
        active={selected === "press-och-media"}
      >
        {content[lang].buttons[2]}
      </SubmenuLink>
    </div>
  );
}
